...
public class Router {
    ...
    public static void put(String url, Class<? extends AppCompatActivity> clazz, Interceptor... interceptor) {
        //url必须以 "/" 结尾
        url = fixUrl(url);
    ...
    public Router activity(AppCompatActivity activity) {
    ...
    /**
     * 如果url中包含可选参数，则必须通过{@link #addParam(String, Object)}来传递参数
     *
     * @param name
     * @param value
     * @return
     */
    public Router addParam(String name, Object value) {
    ...
    public class Param {
        ...
        /**
         * 用于{@link android.app.Activity#startActivityForResult(Intent, int)}的方式启动
         */
        ...
        int flag;
        /**
         * 是否需要返回结果，即是否以{@link android.app.Activity#startActivityForResult(Intent, int)}
